...
document.addEventListener("click", function () {
  ...
  let randomQuote = randomIndex;

  quoteText = document.getElementById("quote-text").innerText =
    quoteList[randomQuote];

  wrapperDiv = document.getElementById("wrapper").style.backgroundColor =
    colors[randomIndex];
});
