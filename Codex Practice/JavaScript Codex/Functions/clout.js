...
function mean(viewsArrays) { 
let totalViews = 0;
>>>>>>> 3cc087b920c9dce555908d1783f43b39a00ac468
...
console.log("TikTok");
console.log(
  "Mean: " + mean(recentTikTokViews) + " Median: " + median(recentTikTokViews)
);
...
console.log("YouTube");
console.log(
  "Mean: " + mean(recentYouTubeViews) + " Median: " + median(recentYouTubeViews)
);
